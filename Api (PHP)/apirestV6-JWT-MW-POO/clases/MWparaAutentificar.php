   ...
   */
	public function VerificarUsuario($request, $response, $next) {
		...
		else
		{
			...
			//tipo=Profesor (GET, POST)
			//$datos = array('usuario' => 'rogelio@agua.com','tipo' => 'profe', 'alias' => "PinkBoy");
			
			//tipo=Administrador(todos)
			$datos = array('usuario' => 'rogelio@agua.com','tipo' => 'Administrador', 'alias' => "PinkBoy");
